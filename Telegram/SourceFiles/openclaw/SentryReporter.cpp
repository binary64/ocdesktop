...
QString publicKey() {
	return QStringLiteral("3af6cdd6250ecd14e3a") + QStringLiteral("da8879d07dac5");
}

QString projectId() {
	return QStringLiteral("4511513060966400");
}

QString ingestHost() {
	return QStringLiteral("o97551.ingest.us.sentry.io");
}
